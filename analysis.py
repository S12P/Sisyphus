...
class Analysis:
    def __init__(self, data_type, schedule, dic, operations, arrays_size, chip, dep, operation_list):
        self.data_type = data_type  # FIXME find datatype
    ...
    def analysis(self):
        ...
        for key in list(self.arrays_size.keys()):
            if self.product(self.arrays_size[key]) > (max_comm + min_comm) / 2:
